...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.lgd.community.boot";
    private static final String ARTIFACT_ID = "lgd";
    private static final String PACKAGE_NAME = "cn.zj.lgd";
    private static final String TITLE = "智慧社区管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.lgd.community.boot";
        String artifactIdNew = "lgd";
        String packageNameNew = "cn.zj.lgd";
        String titleNew = "智慧社区管理系统";
