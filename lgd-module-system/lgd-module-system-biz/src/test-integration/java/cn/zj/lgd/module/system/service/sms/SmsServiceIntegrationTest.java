...
import cn.zj.lgd.framework.sms.config.LgdSmsAutoConfiguration;
import cn.zj.lgd.module.system.test.BaseDbAndRedisIntegrationTest;
import cn.zj.lgd.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO @芋艿：需要迁移
@Import({LgdSmsAutoConfiguration.class,
