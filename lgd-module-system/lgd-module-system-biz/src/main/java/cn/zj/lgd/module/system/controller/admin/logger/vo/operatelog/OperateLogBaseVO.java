package cn.zj.lgd.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "cn.zj.lgd.adminserver.UserController.save(...)")
