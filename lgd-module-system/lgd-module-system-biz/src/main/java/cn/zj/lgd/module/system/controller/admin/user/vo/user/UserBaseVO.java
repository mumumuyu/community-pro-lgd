package cn.zj.lgd.module.system.controller.admin.user.vo.user;

import cn.zj.lgd.framework.common.validation.Mobile;
...
public class UserBaseVO {
    ...
    @ApiModelProperty(value = "用户账号", required = true, example = "lgd")
    ...
    @ApiModelProperty(value = "用户邮箱", example = "lgd@iocoder.cn")
