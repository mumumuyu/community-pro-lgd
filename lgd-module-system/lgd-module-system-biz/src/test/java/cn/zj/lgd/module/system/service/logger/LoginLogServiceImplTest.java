...
import cn.zj.lgd.framework.test.core.util.RandomUtils;
import cn.zj.lgd.module.system.api.logger.dto.LoginLogCreateReqDTO;
import cn.zj.lgd.module.system.controller.admin.logger.vo.loginlog.LoginLogExportReqVO;
import cn.zj.lgd.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import cn.zj.lgd.module.system.dal.dataobject.logger.LoginLogDO;
import cn.zj.lgd.module.system.dal.mysql.logger.LoginLogMapper;
...
import static cn.zj.lgd.module.system.enums.logger.LoginResultEnum.*;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        LoginLogDO loginLogDO = RandomUtils.randomPojo(LoginLogDO.class, logDO -> {
            logDO.setLogType(RandomUtil.randomEle(cn.zj.lgd.module.system.enums.logger.LoginLogTypeEnum.values()).getType());
