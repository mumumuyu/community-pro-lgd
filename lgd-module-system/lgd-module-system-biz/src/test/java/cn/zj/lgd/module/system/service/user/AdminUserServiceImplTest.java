package cn.zj.lgd.module.system.service.user;
...
import cn.zj.lgd.module.infra.api.file.FileApi;
import cn.zj.lgd.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.zj.lgd.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.zj.lgd.module.system.controller.admin.user.vo.user.*;
import cn.zj.lgd.module.system.dal.dataobject.dept.DeptDO;
import cn.zj.lgd.module.system.dal.dataobject.dept.PostDO;
import cn.zj.lgd.module.system.dal.dataobject.dept.UserPostDO;
import cn.zj.lgd.module.system.dal.dataobject.user.AdminUserDO;
import cn.zj.lgd.module.system.dal.mysql.dept.UserPostMapper;
import cn.zj.lgd.module.system.dal.mysql.user.AdminUserMapper;
import cn.zj.lgd.module.system.enums.common.SexEnum;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("lgdyuanma");
        ...
        assertEquals("lgdyuanma", user.getPassword());
    ...
    public void testImportUsers_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("lgdyuanma"))).thenReturn("java");
