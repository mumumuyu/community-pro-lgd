package cn.zj.lgd.module.infra.service.job;

import cn.zj.lgd.framework.common.pojo.PageResult;
import cn.zj.lgd.framework.quartz.core.scheduler.SchedulerManager;
import cn.zj.lgd.framework.quartz.core.util.CronUtils;
import cn.zj.lgd.module.infra.controller.admin.job.vo.job.JobCreateReqVO;
import cn.zj.lgd.module.infra.controller.admin.job.vo.job.JobExportReqVO;
import cn.zj.lgd.module.infra.controller.admin.job.vo.job.JobPageReqVO;
import cn.zj.lgd.module.infra.controller.admin.job.vo.job.JobUpdateReqVO;
import cn.zj.lgd.module.infra.convert.job.JobConvert;
import cn.zj.lgd.module.infra.dal.dataobject.job.JobDO;
import cn.zj.lgd.module.infra.dal.mysql.job.JobMapper;
import cn.zj.lgd.module.infra.enums.job.JobStatusEnum;
...
import static cn.zj.lgd.framework.common.util.collection.CollectionUtils.containsAny;
