package cn.zj.lgd.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.zj.lgd.framework.excel.core.annotations.DictFormat;
import cn.zj.lgd.framework.excel.core.convert.DictConvert;
import cn.zj.lgd.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(cn.zj.lgd.module.system.enums.DictTypeConstants.USER_TYPE)
