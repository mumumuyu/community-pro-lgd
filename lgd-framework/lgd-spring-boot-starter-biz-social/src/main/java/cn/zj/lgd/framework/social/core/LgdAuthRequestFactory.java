package cn.zj.lgd.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.zj.lgd.framework.social.core.enums.AuthExtendSource;
import cn.zj.lgd.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class LgdAuthRequestFactory extends AuthRequestFactory {
    ...
    public LgdAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
