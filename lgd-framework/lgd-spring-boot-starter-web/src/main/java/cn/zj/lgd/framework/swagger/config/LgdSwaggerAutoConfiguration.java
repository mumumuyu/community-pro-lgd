package cn.zj.lgd.framework.swagger.config;

import cn.zj.lgd.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
import static cn.zj.lgd.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
@ConditionalOnProperty(prefix = "lgd.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class LgdSwaggerAutoConfiguration {
...
//                .apis(basePackage("cn.zj.lgd.module.system")) // 可用于 swagger 无法展示时使用
