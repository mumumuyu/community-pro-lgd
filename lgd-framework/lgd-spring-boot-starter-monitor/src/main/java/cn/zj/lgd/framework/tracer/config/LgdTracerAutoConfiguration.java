...
import cn.zj.lgd.framework.tracer.core.aop.BizTraceAspect;
import cn.zj.lgd.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "lgd.tracer", value = "enable", matchIfMissing = true)
public class LgdTracerAutoConfiguration {
