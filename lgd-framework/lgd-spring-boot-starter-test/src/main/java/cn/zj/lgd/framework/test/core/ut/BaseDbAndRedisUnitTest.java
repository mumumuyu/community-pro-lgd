package cn.zj.lgd.framework.test.core.ut;
...
import cn.zj.lgd.framework.test.config.RedisTestConfiguration;
import cn.zj.lgd.framework.test.config.SqlInitializationTestConfiguration;
...
public class BaseDbAndRedisUnitTest {
    ...
    @Import({
            ...
            LgdRedisAutoConfiguration.class, // 自己的 Redis 配置类
