package cn.zj.lgd.module.member.service.user;
...
import cn.zj.lgd.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import cn.zj.lgd.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, LgdRedisAutoConfiguration.class})
